...
println 'Number of seconds processed: ' + timeSizeMap.size()
...
set title "Marcin M"
set key left box
plot "C:\\Project\\Experiments\\resources\\gnuplot.txt" using 1:2 index 0 title "HFCS" with lines
